...
int main(void){
    ...
    char primeira_linha_digitada[10], primeira_coluna_digitada[10];
    char segunda_linha_digitada[10], segunda_coluna_digitada[10];
    char nomeDoJogador1 [20];
    char nomeDoJogador2 [20];

    int jogadorOnePontuacao;
    int jogadoTwoPontuacao;
    int opcaoMenuDigitada;
    int valorOpcaoMenu;
    ...
    do{
       exibirMenuPrincipal();
       scanf("%i", &opcaoMenuDigitada);

       valorOpcaoMenu = opcaoMenu(opcaoMenuDigitada);
       if(valorOpcaoMenu == 0){
            printf("\n\nOpcao invalida!\n\n");
       }
       system("cls");

    }while(valorOpcaoMenu == 0 || valorOpcaoMenu == 2);
    ...
    while(jogador1.pontuacao + jogador2.pontuacao < 8){
        ...
        for(index=1; index<3; index++){
            ...
            while(1){
                ...
                printf("coluna:");
                scanf(" %s", &segunda_coluna_digitada);
    ...
    if(jogador1.pontuacao > jogador2.pontuacao){
        printf("\nO jogador %s Ganhou!",nomeDoJogador1);
    }else if (jogador1.pontuacao < jogador2.pontuacao){
        printf("\nO jogador %s Ganhou!",nomeDoJogador2);
    }else{
        printf("\n Empate!");
    }
